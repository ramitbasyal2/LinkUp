  ...
  return (
    user && (
      <div className="flex flex-col h-screen">
        <div
          className="chatbox-nav flex items-center gap-2 
        ...
        <div>
          {/* messages section */}
            ...
            <div className="message h-full overflow-y-scroll">
              <div className="chat max-w-4xl">
                {
                  messages.toSorted((a,b)=> new Date(a.createdAt) - new Date(b.createdAt)).map((message, index)=>(
                    <div key={index} className={`flex flex-col ${message.to_user_id !== user._id ? 
                      'items-start' :'items-end'}`}>
                         <div className= {`chat-msg text-sm max-w-sm bg-white text-slate-700 rounded-lg shadow
       ...
       {/* input section */}
            <div className="inputs">
                 <div className="input flex items-center gap-3 bg-white w-full 
                 max-w-xl mx-auto border border-gray-200 shadow rounded-full ">
                    ...
                    <button onClick={sendMessage} className="send-btn bg-gradient-to-br from-indigo-500 to-purple-600 
