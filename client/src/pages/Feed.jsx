...
useEffect(()=>{
   fetchFeeds()
    ...
    return !loading ? (
    <div className='h-full overflow-y-scroll no-scrollbar xl:pr-5 flex
 ...
 {/* Right sidebar  */}
 <div className=' max-xl:hidden sticky top-11'>
  <div className='sponsored max-w-xs bg-white text-xs p-4 rounded-md inline-flex flex-col gap-2 shadow'>
