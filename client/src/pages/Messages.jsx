...
const Messages = () => {
  ...
  return (
    <div className='min-h-screen relative bg-slate-50'>
      <div className='messages max-w-7xl'>
        {/* title */}
        <div className='message1'>
          <h1 className='msg-text text-3xl font-bold text-slate-900'>Messages</h1>
  ...
  <div className='flex flex-col gap-6'>
        {dummyConnectionsData.map((user)=>(
          <div key={user._id} className='msg-detail max-w-[650px] flex flex-wrap gap-5 p-6 bg-white shadow rounded-md'>
